          ...
          <div className="lg:w-1/2 flex flex-col items-center lg:items-start text-center lg:text-left">
            <div className="max-w-lg">
              ...
              <div className="flex flex-col items-center lg:items-start w-full gap-3">
                 <button onClick={onGetStarted} className="w-full sm:w-auto flex-grow relative flex items-center justify-center px-8 py-3 text-base font-semibold text-white bg-gray-900 rounded-md cursor-pointer group hover:bg-gray-700 transition-colors">
