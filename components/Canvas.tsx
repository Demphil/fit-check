...
import { RotateCcwIcon, ChevronLeftIcon, ChevronRightIcon, DownloadIcon, ShareIcon } from './icons';
      ...
      <div className="absolute top-4 left-4 right-4 z-30 flex justify-between items-start">
        ...
        {displayImageUrl && !isLoading && (
          <div className="flex items-center gap-2">
            <div className="relative" title={!isShareable ? "Sharing is only available for outfits created with the sample model." : ""}>
                <button
                  onClick={handleShareClick}
                  disabled={!isShareable || copyStatus === 'copied'}
                ...
                >
                  {copyStatus === 'idle' ? <ShareIcon className="w-4 h-4 mr-2" /> : null}
